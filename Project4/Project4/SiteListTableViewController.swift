...
class SiteListTableViewController: UITableViewController {
    ...
    let websites = ["google.com","apple.com","ebay.co.uk"]
    
    override func viewDidLoad() {
        super.viewDidLoad()

        navigationItem.title = "Available sites"
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let vc = storyboard?.instantiateViewController(identifier: "SiteViewer") as? ViewController
        {
